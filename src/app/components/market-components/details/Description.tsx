        ...
        <>
            ...
            <div className='flex flex-col md:flex-row w-full gap-4 my-4'>
                <div className='w-full flex-1 lg:flex-[5] xl:max-w-[872px] h-[375px]'>
                    <Image src={tomato} className='w-full h-full rounded-[8px] object-cover object-center' alt="product-img" />
                </div>
                <div className='rounded-[20px] flex-1 lg:flex-[2] flex flex-col justify-between min-h-full grow shadow-sm p-4 bg-white'>
                    <div className='flex justify-between'>
                        <div className='flex flex-col gap-1'>
                            <h2 className='text-xl 2xl:text-3xl text-[#343F42] font-medium'>Tomatoes</h2>
                        ...
                        <h2 className='text-[#6FA521] font-normal text-xl 2xl:text-[32px] 2xl:leading-9'>N 32,000</h2>
                    </div>
                    <div className='flex flex-col h-3/4  justify-between'>
                        ...
                        <button className='bg-[#6FA521] mt-10 font-medium text-sm rounded-[10px] p-4 text-center text-white' onClick={() => setOpenCreateOfferDialog(true)}>Make an Offer</button>
                    </div>
                </div>
            </div>
